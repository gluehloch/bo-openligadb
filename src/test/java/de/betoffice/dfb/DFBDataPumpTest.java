/*
 * $Id: DFBDataPumpTest.java 3848 2013-11-28 18:30:24Z andrewinkler $
 * ============================================================================
...
/**
 * Test für die Utility Klasse {@link DFBDataPump}.
 *
 * @author by Andre Winkler, $LastChangedBy: andrewinkler $
 * @version $LastChangedRevision: 3848 $ $LastChangedDate: 2013-11-28 19:30:24 +0100 (Do, 28 Nov 2013) $
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "/betoffice-datasource.xml",
		"/betoffice-persistence.xml", "/test-mysql-piratestest.xml" })
public class DFBDataPumpTest {
	...
	public void testExternalDataPumpUtils() {
		...
		DataPump externalDataPumpUtils = new DFBDataPump();
